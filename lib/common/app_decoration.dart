...
InputDecoration cboTextFieldDecoration(BuildContext context,
  ...
  return InputDecoration(
    ...
    prefixIcon: prefixIcon != null || showDefaultPrefixIcon ? Container(
      width: 48,
      child: Row(
...
class AppStyles {
  ...
  static getTextStyle(bool isSemiBold, double fontSize,
      {FontWeight fontWeight = FontWeight.w400, Color? color,double? letterSpacing}) =>
       TextStyle(
        // fontFamily: AppFonts.textRegular,
  ...
  static getTextStylePrimary(bool isSemiBold, double fontSize, Color? mColor) => new TextStyle(
    // fontFamily: AppFonts.textRegular,
      fontWeight: isSemiBold ? FontWeight.w600 : FontWeight.w500,
      color: mColor,
      fontSize: fontSize);

  static getTextStyleGreen(bool isSemiBold, double fontSize) => new TextStyle(
    // fontFamily: AppFonts.textRegular,
  ...
  static getFormat2() => FilteringTextInputFormatter.allow(
      RegExp(r'^\d+\.?\d{0,2}'));

  static getFormat3() => FilteringTextInputFormatter.allow(
      RegExp(r'^\d+\.?\d{0,3}'));

  static getFormatInt() => FilteringTextInputFormatter.allow(
      RegExp(r'[0-9]'));

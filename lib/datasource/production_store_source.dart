...
class ProductionStoresource extends DataGridSource {
  dynamic userId;
  BuildContext mainContext;
  List data = [];
  ProductionStoresource(this._myclientModel, this.mainContext, this.userId) {
    buildDataGridRows();
  }
  ...
  List<ProductionstoreDataReadyStock> _myclientModel = [];

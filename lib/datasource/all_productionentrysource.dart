...
class Allproductionentrysource extends DataGridSource {
  dynamic userId;
  BuildContext mainContext;
  List data = [];
  Allproductionentrysource(this._myclientModel, this.mainContext, this.userId) {
    buildDataGridRows();
  }
  ...
  List<AllProductionentryData> _myclientModel = [];
  ...
  Future<void> onCellSubmit(DataGridRow dataGridRow,
    ...
    if (column.columnName == 'Status') {
      dataGridRows[dataRowIndex].getCells()[rowColumnIndex.columnIndex] =
          DataGridCell<double>(columnName: 'Status', value: newCellValue);
      _myclientModel[dataRowIndex].status = newCellValue;
    } else if (column.columnName == 'ProdNum') {
      dataGridRows[dataRowIndex].getCells()[rowColumnIndex.columnIndex] =
          DataGridCell<String>(columnName: 'ProdNum', value: newCellValue);
      _myclientModel[dataRowIndex].prodNum = newCellValue;
    } else if (column.columnName == 'DateCreated') {
      dataGridRows[dataRowIndex].getCells()[rowColumnIndex.columnIndex] =
          DataGridCell<String>(columnName: 'DateCreated', value: newCellValue);
    ...
    } else if (column.columnName == 'Accepted') {
      dataGridRows[dataRowIndex].getCells()[rowColumnIndex.columnIndex] =
          DataGridCell<String>(columnName: 'Accepted', value: newCellValue);
      _myclientModel[dataRowIndex].accepted = newCellValue;
    } else {
      dataGridRows[dataRowIndex].getCells()[rowColumnIndex.columnIndex] =
